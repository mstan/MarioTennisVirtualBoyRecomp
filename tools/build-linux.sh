...
PREBUILD_CMD=""
POSTBUILD_CMD=""
# prod/debug -> framework cmake flags. Release strips ALL tooling: VBRECOMP_DEBUG_TOOLS
# OFF drops the TCP debug server + wtrace (1M store ring) + fntrace (256K entry ring).
PROD_CMAKE_FLAGS=( -DVBRECOMP_DEBUG_TOOLS=OFF )
DEBUG_CMAKE_FLAGS=( -DVBRECOMP_DEBUG_TOOLS=ON )
# ============================================================================
...
cp "$BUILD/mod-packages/marios-tennis-full-color-0.2.2.vbmod" "$OUT/"
