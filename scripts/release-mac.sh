...
REPO_NAME="MarioTennisVirtualBoyRecomp"      # GitHub repo / zip basename
APP_NAME="Mario's Tennis"        # .app display name (may contain spaces)
TARGET="vb-runtime"            # cmake target == built binary filename in build-mac/
SYSTEM="vb"            # nes | snes | genesis | vb | psx
VERSION="v0.1.0-macos"          # release tag, e.g. v0.1.0-macos
ROM_HINT="Mario's Tennis (Virtual Boy) .vb dump"        # human description of the ROM the user must supply
# ==============================================
